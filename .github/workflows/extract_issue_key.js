...
} else if (CURRENT_PR_TITLE.match(regex)) { // check if PR title starts with a different issue key from the one in the branch name
    console.log(`PR title starts with an ISSUE_KEY other than ${ISSUE_KEY}: ${CURRENT_PR_TITLE.match(regex)[0]}`);
